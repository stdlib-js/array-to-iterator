...
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-to-iterator/tags). For example,

```javascript
import array2iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-to-iterator@v0.2.1-deno/mod.js';
```
...
[@stdlib/array/to-circular-iterator]: https://github.com/stdlib-js/array-to-circular-iterator/tree/deno
